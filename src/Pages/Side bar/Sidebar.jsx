...
import { adminNavData } from "../../utils/navData";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const { data, isLoading } = useGetAllCategoryQuery(undefined, { refetchOnMountOrArgChange: true })
  const customerNavData = transformCategoryData(data ? data?.data : [])
