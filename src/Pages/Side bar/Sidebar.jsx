...
const Sidebar = () => {
  ...
  const [sidebarOpen, setSidebarOpen] = useState(false); // Track sidebar visibility on mobile
  ...
  return (
    <>
      ...
      <div className="md:hidden p-4 bg-gray-900 text-white fixed top-0 left-0 z-50 w-full flex justify-between items-center">
      ...
      >
        <ul>
          <p className="text-gray-300 font-semibold text-lg ps-3 py-4">General</p>
