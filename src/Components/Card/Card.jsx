...
const Card = ({ data }) => {
    ...
    return (
        <div className=" h-full ">
            ...
            <Link to={`/details/${_id}`} className="border inline-block border-red-500 mt-20 mx-4  h-[235px] w-[200px] rounded-lg relative overflow-hidden bg-gradient-to-r from-[#1a2531] to-[#10192B] ">
                <img
                ...
                <div className="text-gray-400 bg-[#232d3e] font-semibold grid grid-cols-2 absolute left-0 right-0 bottom-0 rounded-b-lg ">
                    ...
                    <Link to={''} onClick={() => handelAddToCart(data)} className=" flex items-center justify-center hover:text-white  hover:bg-gradient-to-r from-[#62c750] to-[#02a92f] border-r border-gray-600 ">
                        <FaShoppingCart className="text-center mr-1 text-xl" />

                    </Link>

                    <Link to={''} onClick={() => handelByNow(data)} className="flex items-center justify-between ps-3 pe- py-1 hover:bg-gradient-to-r from-[#62c750] to-[#02a92f] hover:text-white text-sm">
                        <span>
